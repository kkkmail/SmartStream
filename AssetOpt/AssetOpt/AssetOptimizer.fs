...
module Optimization = 
    ...
    let runOptimizer (allData : AllData) : unit = 

        printfn "%s\n%s\nRunning optimization for number of assets = %A, number of contracts = %A" sep sep allData.positions.Length allData.contracts.Length
        ...
        printfn "Optimization time: %f ms.\n%s\n\n\n" stopWatch.Elapsed.TotalMilliseconds sep
